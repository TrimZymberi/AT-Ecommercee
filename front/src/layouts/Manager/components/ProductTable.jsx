  ...
  useEffect(() => {
    ...
    axiosClient
      ...
      .then((response) => {
        ...
        // RESPONSE NEEDED FOR CATEGORY NAME AND USERNAME
        response.data.product.forEach((item) => {
          // SHOWS USERNAME BASED ON ID
          setLoadingData(true);
          axiosClient
        ...
        // SHOWS CATEGORY NAME BASED ON ID
        response.data.product.forEach((item) => {
          setLoadingData(true);
          axiosClient
            .get(`category/${item.category_id}/name`)
            .then((res) => {
              const name = res.data.name;
