                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={(event) => updateProduct(event, currentUser ? currentUser.id : '')} className="space-y-4 md:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="file" onChange={onImageChoose} name="preview" id="preview" className="bg-gray-50 border border-gray-300 text-gray-500 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-4.5" />
                                    {inputErrorList.preview && (
                                        <p className="text-red-500 text-sm mt-1">{inputErrorList.preview}</p>
                                    )}
                                </div>
                                <div>
                                ...
                                <div className="form-group  mb-2">
                                    ...
                                    ></textarea>
                                    <div className='mt-1'>
                                        <span className="text-red-500 text-sm mt-1">{inputErrorList.description}</span>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    {inputErrorList.category && (
                                        <p className="text-red-500 text-sm mt-1">{inputErrorList.category}</p>
                                    )}
                                </div>
                                <div className='mt-1'>
                                    <span className="text-red-500 text-sm">{inputErrorList.category}</span>
                                </div>
                                <div>
                                    <label htmlFor="retail_price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Retail Price</label>
                                    <input type="number" value={product.retail_price} onChange={handleInput} name="retail_price" id="retail_price" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Retail Price" />
                                    <div className='mt-1'>
                                        <span className="text-red-500 text-sm">{inputErrorList.retail_price}</span>
                                    </div>
                                </div>
                                <div>
                                    <label htmlFor="market_price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Market Price</label>
                                    <input type="number" value={product.market_price} onChange={handleInput} name="market_price" id="market_price" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Market Price" />
                                    <div className='mt-1'>
                                        <span className="text-red-500 text-sm">{inputErrorList.market_price}</span>
                                    </div>
                                </div>
