...
import CategoryTableSelekton from "./core/CategoryTable_skeleton";
        ...
        <tr key={index}>
          ...
          <td className="px-6 py-4 whitespace-nowrap">
            <div className="text-sm text-gray-500 underline text-center flex items-center justify-center">
              <svg
                aria-hidden="true"
                class="opacity-100 w-6 h-6 mr-2 text-gray-200 animate-spin  fill-red-600"
                viewBox="0 0 100 101"
                fill="none"
