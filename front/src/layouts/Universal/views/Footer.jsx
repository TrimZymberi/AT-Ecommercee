        ...
        <footer className="bg-white">
            <div className="mx-auto w-full max-w-screen-xl">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Shortcuts</h2>
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li className="mb-4">
                                <Link to="/ourlocations" className="hover:underline">Our Locations</Link>
                            </li>
                            <li className="mb-4">
                ...
                <div className="bg-transparent px-4 py-6 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <Link to="https://flowbite.com/">Prese™</Link>. All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>
