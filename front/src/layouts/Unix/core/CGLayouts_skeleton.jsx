                    ...
                    <div className="flex items-center justify-center">
                        <form className="flex items-center">
                            ...
                            <div className="relative w-full">
                                ...
                                <input disabled type="text" id="simple-search" className="bg-white outline-none shadow-md text-sky-900 text-sm hover:cursor-wait focus:ring-sky-300 block w-full p-3.5 pl-10" placeholder="Search products" />
                            </div>
