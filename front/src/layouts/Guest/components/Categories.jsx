...
export default function Categories() {
    return (
        <div>
            ...
            {/* <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 p-4 gap-4 bg-white">
                <div href="#" class="transition-transform shadow-xl rounded-md p-2">
                    <div class="absolute flex items-center justify-center rounded-full w-10 text-center bg-sky-200 p-2 text-sky-500">
                        999
                    </div>
                    <img src="https://butonks.com/office/images/detailed/15/gigabyte-g5-ge-12th-gen-2.png" alt="" />
                    <div class="flex">
                        <label class="flex justify-center text-start text-gray-700">GIGABYTE G5 ME 15.6" FHD 144Hz
                        </label>
                        <div class="flex-flow p-1 hover:bg-opacity-90 hover:border-opacity-90">
                            <button class="text-sky-100 bg-sky-900 px-4 hover:scale-105 hover:rounded-sm hover:bg-sky-800 transition-all">Click for details</button>
                            <price class="flex justify-end font-semibold tracking-tighter text-sky-900 text-2xl border-sky-900 border-4 p-1 rounded-b-sm">9,999EUR</price>
                        </div>
                    </div>
                </div>
            </div> */}
