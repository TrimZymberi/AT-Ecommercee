  ...
  return (
    ...
    <div className='flex justify-center items-center h-screen  bg-sky-50'>
      <div className='w-96 scale-x-110 scale-y-110 p-6 shadow-lg bg-white rounded-md'>
          <h1 className='text-3xl block text-center font-semibold'><i class="fa-solid fa-user"></i> Register</h1>
          <hr className='mt-3'/>
          <div className='mt-3'>
            <label htmlFor="name" className='block text-lg mb-2'>Name</label>
            <input type="text" id='name' className='border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600' placeholder='Enter name'/>
          </div>
          <div className='mt-3'>
