...
import logo from '../../../Components/img/PC.png'
...
export default function GuestNav() {
  ...
  <a href="" class="flex items-center">
      <img src={logo} class="h-9 mr-3" alt="Flowbite Logo"/>
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AT-ELECTRONICS</span>
  </a>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <div class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"> 
        <div>
        <button class="p-2 ml-2 text-sm font-medium text-white ">
        ...
        <div>
        <button  onClick={toggleDrawer} class="p-2 ml-0 text-sm font-medium text-white" >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
