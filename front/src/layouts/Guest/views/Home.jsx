...
export default function Home() {
    ...
    return (
        <div className='bg-white backdrop-filter backdrop-blur-lg bg-opacity-20'>
            {showPopup && (
                <div class="fixed top-0 right-2 rounded-sm flex p-4 gap-2 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50">
                    <svg class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                    </svg>
                    <div class="ml-3 text-sm font-medium">
                        You registered successfully. You can now <a href="/login" class="font-semibold underline hover:no-underline">Login</a>. Join if you want.
                    </div>
                    <button
                        onClick={hideAlert}
                        type="button"
                        class="ml-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg hover:text-red-800 focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8"
